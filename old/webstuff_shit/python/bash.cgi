...
function panel_top {
echo "
<div id=panel_top class='top'>
<table class='left'><tr>
<td class='invert'>bash.localdomain</td>
<td><a href='python.cgi'><div class='links'>Python</div></a></td>
<td><a href='debug.cgi'>_Debug_</a></td>
<td><a href='header.cgi'>header</a></td>
</tr></table>
...
function variables {
  print "<fieldset><legend></legend></fieldset>"
}
