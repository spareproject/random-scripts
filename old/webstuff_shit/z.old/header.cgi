...
function panel_top {
  ...
  echo "<table class='left'><tr><td><a href='bash.cgi' class='invert'>spareproject.localdomain</a></td><td><a href='debug.cgi'>debug</a></td><td><a href='about.cgi'>about</a></td></tr></table></table>"
  echo "<table class='right'><tr><td>[ group ]</td><td>[ userstats ]</td><td>[ auth.key ]</td><td>[ session.key ][ $USER `date` ]<td></tr></table>"
  echo "</div>"
...
function auth_fieldset { 
  echo "<fieldset><legend><h3><b>$FUNCNAME</b></h3></legend><form action='session.cgi' method='post'><table>"
  echo "<tr><td>auth_key: </td><td><input type='text' name='uuid'></td><td><input type='submit' name='submit' value='login'></td></tr>"
  echo "</form></table></fieldset>"
}
